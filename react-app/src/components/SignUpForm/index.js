...
function SignUpForm() {
  ...
  // typical error handling, if submitted, check if invalid data and overwrite validation error state value with errors so that a re-render occurs and the page is filled with errors
  useEffect(() => {
    if (isSubmitted) {
      const valErrors = {};
