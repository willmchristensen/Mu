          ...
          <div className="music-details">
            ...
            <div className="music-details-description">
              <p>
                ...
                unde architecto voluptatem amet ipsam nulla aliquid optio
                consequatur deleniti? Iste esse consequatur iure commodi nulla
                amet natus cumque quam error dolores sit deserunt doloribus
                repudiandae itaque quibusdam minus iusto id repellat ipsam odio
                voluptas, impedit modi doloremque. Alias, magnam fugiat!
              </p>
            </div>
          </div>
          <div className="music-owner-buttons">
            {sessionUser && post?.userId === sessionUser?.id && (
              <>
                ...
                <NavLink className="oval-button" to={`/music/${post?.id}/edit`}>
                  Edit music
                </NavLink>
              </>
            )}
