...
const FormNavBar = ({pages, orientation}) => {
    const formNavBar = orientation === 'row' ? 'form-nav-bar-row' : 'form-nav-bar'; 
    const formNavContainer = orientation === 'row' ? 'form-nav-container-row' : 'form-nav-container';
    const formNavItem = orientation === 'row' ? 'form-nav-item-row' : 'form-nav-item'; 
    return (
